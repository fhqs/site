...
<html lang="en">
	<head>
		...
		<meta charset="utf-8">
		<title>FHQS - who needs friends anyway</title>
        ...
        <div class="row row-offcanvas row-offcanvas-left">
            ...
            <div class="column col-sm-2 col-xs-1 sidebar-offcanvas" id="sidebar">
                ...
                <ul class="nav hidden-xs" id="lg-menu">
                    <li class="active"><a href="#featured"><i class="glyphicon glyphicon-list-alt"></i> Slavery</a></li>
                    <li><a href="#stories"><i class="glyphicon glyphicon-list"></i> Fuck that shit</a></li>
                    <li><a href="#"><i class="glyphicon glyphicon-paperclip"></i> Lost and found</a></li>
                    <li><a href="#"><i class="glyphicon glyphicon-refresh"></i> Refresh</a></li>
                </ul>
                <ul class="list-unstyled hidden-xs" id="sidebar-footer">
                    <li>
                      <a href="http://www.bootply.com"><h3>Whatever, united.</h3> <i class="glyphicon glyphicon-heart-empty"></i>Sack</a>
                    </li>
                </ul>
                ...
                <!-- top nav -->
              	<div class="navbar navbar-blue navbar-static-top">  
                    <div class="navbar-header">
                      ...
                      <a href="/" class="navbar-brand logo">fhqs</a>
                  	</div>
